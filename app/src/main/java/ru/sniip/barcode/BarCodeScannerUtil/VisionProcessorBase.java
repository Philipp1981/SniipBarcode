...
import ru.sniip.barcode.BarCodeScannerUtil.common.BitmapUtils;
...
import ru.sniip.barcode.BarCodeScannerUtil.common.VisionImageProcessor;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    @Override
    public void process(ByteBuffer data, FrameMetadata frameMetadata, ru.sniip.barcode.BarCodeScannerUtil.common.GraphicOverlay graphicOverlay) throws FirebaseMLException {
        latestImage = data;
    ...
    @Override
    public void process(Bitmap bitmap, ru.sniip.barcode.BarCodeScannerUtil.common.GraphicOverlay graphicOverlay) {
